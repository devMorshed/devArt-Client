...
export default function Footer() {
	return (
		<footer className="relative mt-10 py-6 w-full dark:bg-gray-800 dark:!text-gray-50">
			<div className="mx-auto w-full max-w-7xl px-8">
				...
				<div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-around">
					<h4 className="mb-4 text-center  md:mb-0">
						&copy; {currentYear} {" "}
						<Link className="text-blue-800 dark:text-blue-200" to="https://github.com/devMorshed">
							devMorshed
						</Link>
						. All Rights Reserved.
					</h4>
